...
public class AuthenticationService {
  ...
  public AuthenticationResponse authenticate(
    ...
    if (emailOptional.isPresent()) {
      ...
      if (identity.isNotLocked() // todo: here is where I match keys
        ...
        if (true) {
          ...
          if (isAuthorized) {
            final var authCode =
                authCodeInstantiator.instantiate(
                    identity, redirectUri, clientId, codeChallengeMethod, codeChallenge);
