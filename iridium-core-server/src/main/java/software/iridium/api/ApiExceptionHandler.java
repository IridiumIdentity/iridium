...
public class ApiExceptionHandler {
    ...
    public @ResponseBody
    ApiResponse handleNotAuthorizedException(final Exception e) {
    ...
    public @ResponseBody
    ApiResponse handeDuplicateResourceException(final Exception e) {
    ...
    public @ResponseBody
    ApiResponse handleResourceNotFoundException(final Exception e) {
    ...
    public @ResponseBody
    AccessTokenErrorResponse handleAccessTokenBadRequest(final Exception e) {
        return new AccessTokenErrorResponse(HttpStatus.BAD_REQUEST.toString(), e.getMessage().toLowerCase());
    }
}
