...
@Component
public class TenantLogoUpdateResponseMapper {

  public TenantLogoUrlUpdateResponse map(LoginDescriptorEntity entity) {
    final var response = new TenantLogoUrlUpdateResponse();
    response.setLogoUrl(entity.getLogoURL());
    response.setLoginDescriptorId(entity.getId());
