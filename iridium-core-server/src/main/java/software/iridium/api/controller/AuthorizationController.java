 ...
 *             @RequestParam(name = "response_type") final String responseType,
 ...
 *             @RequestParam(name = "code_challenge") final String codeChallenge,
 *             @RequestParam(name = "code_challenge_method") final String codeChallengeMethod
 */
@CrossOrigin
@RestController
public class AuthorizationController {
    ...
    public RedirectView proxyAuthorizationRequestToProvider(
        ...
        final var redirectDestination = authorizationService.proxyAuthorizationRequestToProvider(responseType, state, redirectUri, clientId, provider);
    ...
    @RequestMapping(value = "/oauth/authorize", method = { RequestMethod.POST, RequestMethod.GET })
    ...
    public AccessTokenResponse exchange(HttpServletRequest servletRequest, @RequestParam Map<String, String> params) {
