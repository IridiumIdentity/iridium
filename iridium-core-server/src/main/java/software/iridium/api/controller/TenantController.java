...
public class TenantController {
    ...
    @PostMapping(value = "tenants", consumes = CreateTenantRequest.MEDIA_TYPE, produces = CreateTenantResponse.MEDIA_TYPE)
    public ApiDataResponse<CreateTenantResponse> create(final HttpServletRequest request, @RequestBody final CreateTenantRequest tenantRequest) {
