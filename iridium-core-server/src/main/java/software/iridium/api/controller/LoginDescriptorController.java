...
public class LoginDescriptorController {
    ...
    @Resource
    private LoginDescriptorService descriptorService;

    @GetMapping(value = "login-descriptors/{subdomain}", produces = LoginDescriptorResponse.MEDIA_TYPE)
    public ApiDataResponse<LoginDescriptorResponse> getBySubdomain(@PathVariable(value = "subdomain") final String subdomain) {
