...
public class IdentityController {
    ...
    @RequestMapping(value="/tenants/{tenant-id}/identities", method= RequestMethod.GET, produces= IdentityResponse.MEDIA_TYPE)
    ...
    public RedirectView createWithFormSubmit(@ModelAttribute final CreateIdentityRequest request,
