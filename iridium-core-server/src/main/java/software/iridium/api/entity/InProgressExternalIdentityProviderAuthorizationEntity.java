...
@Entity
@AttributeOverride(name="id", column=@Column(name="in_progress_external_identity_provider_authorization_id"))
@Table(name="in_progress_external_identity_provider_authorizations")
public class InProgressExternalIdentityProviderAuthorizationEntity extends UuidIdentifiableAndAuditable {
