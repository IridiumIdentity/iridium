...
class PasswordServiceTest {
    ...
    @Mock
    private PasswordResetTokenEntityInstantiator mockTokenInstantiator;
    @Mock
    private PasswordEventHandler mockPasswordEventHandler;
    @Mock
    private ApplicationEntityRepository mockApplicationRepository;
    @InjectMocks
    private PasswordService subject;
    ...
    public void initiatePasswordReset_AllGood_BehavesAsExpected() {
        ...
        verify(mockPasswordEventHandler).handlePasswordResetInitiatedEvent(same(identity), same(clientId));
    ...
    public void initiatePasswordReset_ApplicationNotFound_ExceptionThrown() {
        ...
        final var exception = assertThrows(ResourceNotFoundException.class, () -> subject.initiatePasswordReset(request));
