...
class IdentityEntityInstantiatorTest {
    ...
    @Mock
    private EmailEntityInstantiator mockEmailInstantiator;
    @Mock
    private IdentityPropertyEntityInstantiator mockPropertyInstantiator;
    @InjectMocks
    private IdentityEntityInstantiator subject;
    ...
    public void instantiate_AllGood_InstantiatesAsExpected() {
        ...
        MatcherAssert.assertThat(response.getPrimaryEmail().getEmailAddress(), is(equalTo(emailAddress)));
    ...
    public void instantiateFromGithub_AllGood_InstantiatesAsExpected() {
        ...
        verify(mockEmailInstantiator).instantiatePrimaryEmail(same(emailAddress));
        verify(mockPropertyInstantiator).instantiateGithubProperties(same(githubResponse), any(IdentityEntity.class));
    }
}
