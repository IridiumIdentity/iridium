...
class LoginDescriptorResponseMapperTest {
    ...
    @Mock
    private ExternalProviderLoginDescriptorResponseMapper mockResponseMapper;
    @InjectMocks
    private LoginDescriptorResponseMapper subject;
    ...
    public  void map_AllGood_MapsAsExpected() {
        ...
        MatcherAssert.assertThat(response.getExternalProviderDescriptors(), sameInstance(descriptorResponses));
    }
}
