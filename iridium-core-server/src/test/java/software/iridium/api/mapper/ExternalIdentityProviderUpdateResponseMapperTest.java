...
class ExternalIdentityProviderUpdateResponseMapperTest {

  private ExternalIdentityProviderUpdateResponseMapper subject;

  @BeforeEach
  public void setUpForEachTestCase() {
    subject = new ExternalIdentityProviderUpdateResponseMapper();
  }
