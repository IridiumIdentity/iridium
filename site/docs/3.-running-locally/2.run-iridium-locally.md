...
You'll need to set your GitHub Client credentials in the file below.  [Instructions on how to do this with GitHub are here.](../5.-connecting-social-identity-providers/create-github-application.md)  You can do this by executing. 
```shell
