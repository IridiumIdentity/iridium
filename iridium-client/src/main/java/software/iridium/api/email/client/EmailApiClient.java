...
public class EmailApiClient {
    ...
    public ApiDataResponse<EmailSendResponse> sendNewIdentityVerificationMail(final EmailSendRequest request) {
        final var restPoster = new RestPoster<EmailSendRequest, ApiDataResponse<EmailSendResponse>>(this.restTemplate);
        ...
        return restPoster.post(url, headers, request, new ParameterizedTypeReference<ApiDataResponse<EmailSendResponse>>() {}, new ErrorHandler());
    }
}
