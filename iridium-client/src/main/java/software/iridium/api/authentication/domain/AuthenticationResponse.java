...
public class AuthenticationResponse implements Serializable {
    ...
    public static final String MEDIA_TYPE = "application/vnd.iridium.id.authentication-response.1+json";
    ...
    private AuthenticationResponse(final String userToken, final String userRefreshToken, final Boolean applicationIsAuthorized) {
        this.userToken = userToken;
        this.userRefreshToken = userRefreshToken;
        this.applicationIsAuthorized = applicationIsAuthorized;
    }

    private AuthenticationResponse(final String userToken, final String userRefreshToken, final boolean applicationIsAuthorized, final String applicationName, final String tenantWebsite, final String appBaseurl, final String applicationRedirectUrl, final String authorizationCode) {
        this.userToken = userToken;
        this.userRefreshToken = userRefreshToken;
        this.applicationIsAuthorized = applicationIsAuthorized;
    ...
    public static AuthenticationResponse of(final String userToken, final String userRefreshToken, final Boolean isAuthorized) {
    ...
    public static AuthenticationResponse of(
        ...
        return new AuthenticationResponse(userToken, userRefreshToken, isAuthorized, applicationName, tenantWebsite, appBaseurl, applicationRedirectUrl, authorizationCode);
    }
}
