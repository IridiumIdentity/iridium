...
public class ApplicationTypeSummary implements Serializable {
    ...
    public static final String MEDIA_TYPE_LIST = "application/vnd.iridium.id.authz.application-type-summary-list.1+json";
    ...
    public static ApplicationTypeSummary of(final String id, final String name, final String description) {
