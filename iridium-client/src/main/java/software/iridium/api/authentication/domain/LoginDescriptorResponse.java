...
public class LoginDescriptorResponse implements Serializable {
    ...
    public static final String MEDIA_TYPE = "application/vnd.iridium.id.authn.login-descriptor-response.1+json";
    ...
    public void setExternalProviderDescriptors(final List<ExternalProviderLoginDescriptorResponse> externalProviderDescriptors) {
